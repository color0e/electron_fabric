...
var os            = require('os');
var store_path = path.join(os.homedir(), '.cert-store');

var member_user = null;  
var tx_id = null;

module.exports = (function(c_name,p_addr,o_addr,e_addr){

    var helper = {};
    // console.log('Store path:'+store_path);
    var channel = fabric_client.newChannel(c_name);
    var peer = fabric_client.newPeer(p_addr);
    channel.addPeer(peer);
    var order = fabric_client.newOrderer(o_addr);
